# CerberusVision Phase 5.3 — From-Scratch QLoRA Fine-Tuning

Phase 5.3: Tum veriyle sifirdan QLoRA egitimi.

## Icerik

- `data/train.jsonl` — Egitim verisi
- `data/validation.jsonl` — Dogrulama verisi (global aile bazli, sifir sizinti)
- `CerberusVision_Phase5_3_Qwen_QLoRA.ipynb` — Colab egitim defteri

## Google Drive'a Yukleme

Colab'da calistirmadan once:

1. `MyDrive/CerberusVision_Phase5_3_Colab/` klasoru olusturun
2. `data/` klasorunu buraya yukleyin
3. `CerberusVision_Phase5_3_Qwen_QLoRA.ipynb` dosyasini bu klasore yukleyin
